...
const Lenguages = () => {
    ...
    return (
        <div className="flex flex-col items-center p-3 border-2 rounded-md w-3/4 m-auto mt-5">
            <h1 className="text-3xl font-bold">Lenguages</h1>
            <div className='flex flex-wrap justify-center pt-3 gap-4'>
